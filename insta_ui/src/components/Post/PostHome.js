...
const PostHome = ({ post, user, postDetail, likePost, unlikePost, submitComment, getComment, deletePost }) => {
    ...
    <>
      ...
      <Card bordered={false} className="mb-2 ml-4 mr-4 mr-md-0" >
        ...
        <div className="actions" style={{ marginTop: "auto" }}>
          ...
          // }}
          >
            <Badge showZero count={post.commentCount} onClick={showModal}>
...
export default connect(mapStateToProps, mapActionsToProps)(PostHome);
